...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        icon_path = os.path.join(self.cwd, '..', '..', 'img', 'logo2.png')
        icon = QIcon(icon_path) # Noto Sans Bold 270
        QApplication.instance().setWindowIcon(icon)
    
        settings = os.path.join(self.cwd, '..', '..', 'config', 'settings.json')
        history = os.path.join(self.cwd, '..', '..', 'data', 'history.json')
        macros = os.path.join(self.cwd, '..', '..', 'data', 'macros.json')
    ...
    def _init_signals(self):
        ...
        self.ui.open_macros_btn.clicked.connect(lambda: open_file_editor(os.path.join(self.cwd, '..', '..', 'data', 'macros.json'), update_macro_table))
